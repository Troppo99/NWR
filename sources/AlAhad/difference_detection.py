...
state_dict = torch.load("D:/SBHNL/Resources/Models/Pretrained/AHMDL/HD_V3/best_model.pth")

model.load_state_dict(state_dict)  # Hapus strict=False
model.eval()
...
# video_path = "D:/SBHNL/Videos/AHMDL/Test/testing halaman.mp4"
video_path = "rtsp://admin:oracle2015@10.5.0.236:554/Streaming/Channels/1"
